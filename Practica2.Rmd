...
### Requisitos
Random forest (y en específico el paquete 'ranger', que se usará para entrenar al modelo) no tiene requisitos de preprocesamiento de los datos, por lo que no se realiza ninguna acción en este apartado.
